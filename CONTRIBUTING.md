...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/checkout_intents/helpers/` and `examples/` directory.
...
require_relative "../lib/checkout_intents"
...
```ruby
gem "checkout-intents", git: "https://www.github.com/stainless-sdks/checkout-intents-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/checkout-intents-ruby' '<path-to-repo>'
```

```ruby
gem "checkout-intents", path: "<path-to-repo>"
```
