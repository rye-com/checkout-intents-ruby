  ...
  module Resources
    class Betas
      class CheckoutSessions
        ...
        # their purchases.
        #
        # @overload create(product_url:, quantity:, buyer: nil, constraints: nil, discover_promo_codes: nil, layout: nil, promo_codes: nil, variant_selections: nil, request_options: {})
        #
