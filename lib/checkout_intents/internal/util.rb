    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{::CheckoutIntents::Internal::Type::BaseModel}, got #{input.inspect}"
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(::CheckoutIntents::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
