...
echo -e "\033[32mInstallation: bundle remove checkout-intents && bundle add checkout-intents --source 'https://pkg.stainless.com/s/checkout-intents-ruby/$SHA'\033[0m"
